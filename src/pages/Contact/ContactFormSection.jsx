...
const ContactFormSection = () => {
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "krati.porwal@example.com",
      link: "mailto:krati.porwal@example.com",
    },
    {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      label: "Krati Porwal",
      link: "https://linkedin.com/in/krati-porwal",
    },
  ];
    ...
    <div className="row bg-black g-4 py-5">
      ...
      <div className="col-12 col-md-6">
        ...
        <p className="text-secondary mb-4">
          ...
          I’d love to hear from you. I’m currently open to internship
        ...
        {/* Social Links */}
        <h5 className="fw-semibold mt-4 mb-3 text-light">Connect on Social</h5>
      ...
      <div className="col-6">
        <div className="card border-0 shadow-sm gradient-card text-center p-5 bg-dark text-light">
          ...
          <p className="text-secondary mb-4 mx-auto" style={{ maxWidth: "600px" }}>
            ...
            something amazing. Let's discuss how we can bring your ideas to life!
          </p>

          {/* Buttons Row */}
          <div className="row justify-content-center g-3">
            <div className="col-md-auto col-12">
              <button className="btn btn-primary d-flex align-items-center px-4 py-2 w-100">
